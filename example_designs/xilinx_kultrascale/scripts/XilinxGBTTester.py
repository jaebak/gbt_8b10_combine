...
projectPath = "D:/GBT-FPGA/test/example_designs/xilinx_k7v7/vc707/vivado"
projectName = "vc707_gbt_example_design"
...
for i in range(0, len(bitFileName)):
    ...
    hwServThread = vivado.runTCPServerInThread("run.log", enInfoVerb=False, enWarningVerb=False)
